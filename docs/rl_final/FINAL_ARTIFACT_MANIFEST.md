...
- 영상 1 초기 정책: 로그 기반 분석형 보조 영상 생성 완료
- 영상 2 학습 진행: checkpoint reward 및 그래프 기반 분석형 보조 영상 생성 완료
...
- 영상 1과 영상 2는 gameplay 렌더가 아닌 분석형 영상
- 실제 gameplay 기반 초기 정책과 checkpoint montage는 추가 렌더 시 품질 향상 가능
